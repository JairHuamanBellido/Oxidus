...
export class DefaultPaletteStrategy implements ColorPaletteStrategy {
  generateColorPalette({
    ...
    const lightSidebarBackground = Color(hex).mix(Color("white"), 0.98).hex();
    ...
    const darkSidebarBackground = Color(hex).mix(Color("#0f0f0f"), 0.98).hex();
